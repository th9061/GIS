...
//increments and decrements accordingly when scroll zooming is used
//set max zoom on line 2726 of .cpp
struct zoom_ {
    int level;
};

//returns an int to tell how many times scroll forward/backward was used for zoom
//line 2711 of .cpp
int getZoomLevel();

//access zoomlvl for manipulating zoom level
//initialized on line 2709 of .cpp
extern zoom_ zoomlvl;

extern bool left_hold;
